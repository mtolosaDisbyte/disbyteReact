            ...
            <div className="sb__footer-links">
                ...
                <div className="sb__footer-links_div">
                    ...
                    <div className="socialmedia">
                        ...
                        <p><a href="https://www.twitter.com/"><img src={twitter} alt=""/></a></p>
                        <p><a href="https://www.linkedin.com/"><img src={linkedin} alt=""/></a></p>
                ...
                <div className="sb__footer-below">
                    <div className="sb__footer-copyright">
                        <p>
                            @{new Date().getFullYear()} Disbyte. all right reserved.
                        </p>
                    </div>
